...
function program11(depth0,data) {
  ...
  return "\n          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='Experimente!' />\n            <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n            <img alt='Throbber' class='response_throbber' src='images/throbber.gif' style='display:none' />\n          </div>\n          ";
  }
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.wrap = function(data) {
      ...
      headerArray = parseResponseHeaders(data.getAllResponseHeaders());

      o = {};
      o.content = {};
      o.data = data.responseText;
      o.headers = headerArray;
      o.request = {};
      o.url = this.invocationUrl;
  ...
  ContentTypeView = (function(_super) {
    ...
    ContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=contentType]', $(this.el)).text('Content Type de Resposta');
      return this;
    };
  ...
  ResponseContentTypeView = (function(_super) {
    ...
    ResponseContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=responseContentType]', $(this.el)).text('Content Type de Resposta');
      return this;
    };
