...
*/
if($_SERVER['HTTP_HOST'] == 'intranetrebocadores.wilsonsons.midiadesigners.local'){
	$baseUrl = 'http://intranetrebocadores.wilsonsons.midiadesigners.local/';
}elseif($_SERVER['HTTP_HOST'] == 'intranetrebocadores.wilsonsons.mediainteractive.com.br'){
	$baseUrl = 'http://intranetrebocadores.wilsonsons.mediainteractive.com.br/';
}else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoresdsv.wsrebocadores.com.br') {
	$baseUrl = 'http://portalrebocadoresdsv.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoreshlm​.wsrebocadores.com.br') {
	$baseUrl = 'http://portalrebocadoreshml.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadores.wsrebocadores.com.br') {
	$baseUrl = 'http://portalrebocadores.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoresdsv') {
	$baseUrl = 'http://portalrebocadoresdsv.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoreshml') {
	$baseUrl = 'http://portalrebocadoreshml.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadores') {
	$baseUrl = 'http://portalrebocadores.wsrebocadores.com.br/';
}
/*
...
if($_SERVER['HTTP_HOST'] == 'intranetrebocadores.wilsonsons.midiadesigners.local'){
	$directory = '/var/subversion/www-linux/IntranetRebocadoresWilsonSons/';
}elseif($_SERVER['HTTP_HOST'] == 'intranetrebocadores.wilsonsons.mediainteractive.com.br'){
	$directory = '/var/subversion/wordpress/IntranetRebocadores_WilsonSons_HML/';
}else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoresdsv.wsrebocadores.com.br') {
	$directory = '/var/www/portalrebocadoresdsv.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoreshml.wsrebocadores.com.br') {
	$directory = '/var/www/portalrebocadoreshml.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadores.wsrebocadores.com.br') {
	$directory = '/var/www/portalrebocadores.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoresdsv') {
	$directory = '/var/www/portalrebocadoresdsv.wsrebocadores.com.br/';
} else if ($_SERVER['HTTP_HOST'] == 'portalrebocadoreshml') {
	$directory = '/var/www/portalrebocadoreshml.wsrebocadores.com.br/';
...
#$baseDir = '/var/subversion/www-linux/Website-v2WilsonSons/uploads/';
/*
 * ### Advanced Settings
 */
...
$config['Thumbnails'] = Array(
		'url' => '/uploads/_thumbs',
		'directory' => $directory.'uploads/_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 200,
		'maxHeight' => 200,
...
$config['ResourceType'][] = Array(
		'name' => 'Arquivos',				// Single quotes not allowed
		'url' => '/arquivos/',
		'directory' => $directory.'arquivos/',
		'maxSize' => 0,
