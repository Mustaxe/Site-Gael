...
-->
        ...
        <li><label for="crop_image_quality" class="crop_label">Image Quality:</label><input type="text" id="crop_image_quality" class="crop_input" name="crop_image_quality" value="100" /> <span class="field_hint">%</span></li>
