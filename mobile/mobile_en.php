...
$json_destaques = json_decode($json_destaques, TRUE);
  ...
  //JSON CASES
$ch =  curl_init("http://" . $_SERVER[HTTP_HOST] . "/service/cases/1/en");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
<head>
	...
	<style>
		.x-btn-presantation, .x-btn-know {
		    ...
		    font-size: 15px;
		    color: #ffcf13;
		    font-family: DINNextLTPro_Heavy;
	...
	<main id="all">
		<header id="header" class="js-header">			
			...
			<nav class="menu js-menu">
				<ul>
					<li class="wrap-item custom-icon-megaphone js-nav-menu" data-scroll-nav="0"><a href="javascript:void(0)" class="item">NEWS</a></li>
					<li class="wrap-item custom-icon-lamp js-nav-menu" data-scroll-nav="1"><a href="javascript:void(0)" class="item">Cases</a></li>
					<li class="wrap-item custom-icon-smile js-nav-menu" data-scroll-nav="2"><a href="javascript:void(0)" class="item">ABOUT</a></li>
					<li class="wrap-item custom-icon-balloon js-nav-menu" data-scroll-nav="3"><a href="javascript:void(0)" class="item">CONTACT</a></li>
				</ul>
		...
		<div class="wrap-case js-wrap-case" data-scroll-index="1">
			...
			<section id="case" class="js-case">
				<div class="back js-back" data-scroll-goto="1">Back</div>
...
<section id="about" data-scroll-index="2">
	...
	*/
	...
	<p class="format-1"><?= stripslashes($sobre[$lang]->titulo) ?></p>
	<p class="format-2"><?= stripslashes($sobre[$lang]->subtitulo) ?></p>

	<div>
		<section class="x-know">
			<a href="#" class="x-btn-know" target="_blank">CLICK AND DISCOVER</a>
			
			<div class="x-text-know" style="display: none;">				
				<div class="text"><?php echo str_ireplace(array('<div>', '</div>'), array('<p>', '</p>'),$sobre[$lang]->texto); ?></div>
			</div>
		</section>
	</div>
	...
	<br>
	<div><a href="<?= $sobre[$lang]->arquivo ?>" class="x-btn-presantation" target="_blank">DOWNLOAD THE PRESENTATION</a></div>
	<br>
	...
	<form action="" class="form-default js-form-contact">
		<fieldset class="js-wrap-content-form">
			...
			<div class="line">
				...
				<span class="warn js-warn">
					<small class="js-warn-text"></small>  <small class="icon-attention"></small>
				</span>
			</div>
			<div class="line">
			...
			<br>
			<div class="line">
				<input type="submit" class="btn js-submit" value="Send">
			</div>
		</fieldset>
...
<script>
	...
	$(document).ready(function() {
		...
		$('.x-btn-know').click(function (ev){
			ev.preventDefault();
			$('.x-text-know').toggle('fast');
		});
