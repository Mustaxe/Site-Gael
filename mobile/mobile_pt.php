...
<body>
	<main id="all">
		<header id="header" class="js-header">
			...
			<div class="x-flag-language">
				<a href="mobile.php?lang=en">
					<img src="images/lang/bt_en_peq.png" alt="Idioma">
				</a>
			</div>
			<h1 class="logo">				
	...
	*/
	...
	<h2 class="title">
		<figure>
			<img class="img" src="images/svg/tlt-sobre.svg" alt="">
		</figure>
	</h2>
	...
	<div>
		<section class="x-know">
			<a href="#" class="x-btn-know" target="_blank">CLIQUE E CONHEÇA</a>
	...
	<br>
	<div><a href="<?= $sobre[$lang]->arquivo ?>" class="x-btn-presantation" target="_blank">BAIXE NOSSA APRESENTAÇÃO</a></div>
	<br>
...
<section id="contact" data-scroll-index="3">
	<h2 class="title">
		<figure>
			<img class="img" src="images/svg/tlt-contato.svg" alt="">
		</figure>
	</h2>
